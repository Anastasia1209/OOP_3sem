...
namespace Lab11
{
    internal static class Reflector
    {
        ...
        private static readonly string fileForInfortmationPath = @"D:\Универ\2курс\OOP_3sem\Lab11\Lab11\Reflector.txt";
        ...
        public static void WriteCheckPublicConstructors(string nameClass)
        {
            ...
            if (collectionPublicConstructors.Length > 0)
                if (fileForInfortmation != null) fileForInfortmation.WriteLine("Есть");
                else
                if (fileForInfortmation != null) fileForInfortmation.WriteLine("Нету");
        ...
        public static void WriteMethodsWithUserParametr(string nameClass)
        {
            ...
            Console.Write("Введите параметр, чтобы узнать методы, которые его содержат\n ");
        ...
        public static void Invoke(string nameClass, string nameMethod)
        {
            try
            {
                ...
                List<string> str = File.ReadAllLines(@"D:\Универ\2курс\OOP_3sem\Lab11\Lab11\Invoke.txt").ToList();
