...
namespace Lab13
{
    public class CustomSerializer
    {
        public static void SerializeToBinary<T>(T obj) where T : class
        {
            ...
            using (var fileStream = new FileStream(@"D:\Универ\2курс\OOP_3sem\Lab13\Lab13\Binary.bin", FileMode.OpenOrCreate))
            {
        ...
        public static void SerializeToSoap<T>(T obj) where T : class
        {
            ...
            using (var fileStream = new FileStream(@"D:\Универ\2курс\OOP_3sem\Lab13\Lab13\SOAP.soap", FileMode.OpenOrCreate))
            {
        ...
        public static void SerializeToXml<T>(T obj) where T : class
        {
            ...
            using (var fileStream = new FileStream(@"D:\Универ\2курс\OOP_3sem\Lab13\Lab13\XML.xml", FileMode.OpenOrCreate))
            {
        ...
        public static void SerializeToJson<T>(T obj) where T : class
        {
            ...
            using (var fileStream = new StreamWriter(@"D:\Универ\2курс\OOP_3sem\Lab13\Lab13\JSON.json"))
            {
        ...
        {
            var settings = new JsonSerializerSettings { TypeNameHandling = TypeNameHandling.All };
            using (var fileStream = new StreamReader(@"D:\Универ\2курс\OOP_3sem\Lab13\Lab13\JSON.json"))
            {
