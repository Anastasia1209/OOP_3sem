...
namespace Lab15
{
    static class Program
    {
        static void Main()
        {
            ...
            calculateHypotenuse.Wait();
            Task<double> calculatePlace = new Task<double>(() => (x * y) / 2);
            calculatePlace.Start();
            calculatePlace.Wait();
            Task<double> getConsoleLine = new Task<double>(() => calculateHypotenuse.Result + calculatePlace.Result);
            ...
            Console.WriteLine("\n- - - - - - Task_04 - - - - - -\n");
            Task<double> calculateHypotenuse2 = new Task<double>(() => Math.Sqrt(x * x + y * y));
            Task<double> calculatePerimetr = calculateHypotenuse2.ContinueWith(r => x + y + calculateHypotenuse2.Result);
            calculateHypotenuse2.Start();
